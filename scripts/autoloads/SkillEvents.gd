...
signal apply_status(performer: Actor, target: Actor, context: Dictionary)
signal remove_status(performer: Actor, target: Actor, context: Dictionary)
signal reduce_status_stack(performer: Actor, target: Actor, context: Dictionary)
